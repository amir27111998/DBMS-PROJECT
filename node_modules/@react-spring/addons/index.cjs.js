...
var AnimatedView = animated.createAnimatedComponent(globals.defaultElement);
...
var ParallaxLayer = React__default.memo(function (_ref) {
  ...
  var translate3d = ctrl.animated.translate.interpolate(horizontal ? function (x) {
  ...
  return React__default.createElement(AnimatedView, Object.assign({}, rest, {
    ...
    }, _extends2[horizontal ? 'height' : 'width'] = '100%', _extends2[horizontal ? 'width' : 'height'] = ctrl.animated.space, _extends2.WebkitTransform = translate3d, _extends2.MsTransform = translate3d, _extends2.transform = translate3d, _extends2), rest.style)
  }));
  return null;
});
var Parallax = React__default.memo(function (_ref2) {
  ...
  shared.useOnce(function () {
    ...
    var onResize = function onResize() {
      ...
      globals.requestAnimationFrame(update);
