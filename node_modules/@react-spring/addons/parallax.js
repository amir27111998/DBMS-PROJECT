...
import { defaultElement, requestAnimationFrame } from '@react-spring/shared/globals';
import { Controller, config } from '@react-spring/core';
import { createAnimatedComponent } from '@react-spring/animated';
import { useMemoOne } from 'use-memo-one';
import { useOnce } from '@react-spring/shared';

const AnimatedView = createAnimatedComponent(defaultElement);
...
const ParallaxLayer = React.memo((_ref) => {
  ...
  const translate3d = ctrl.animated.translate.interpolate(horizontal ? x => `translate3d(${x}px,0,0)` : y => `translate3d(0,${y}px,0)`);
